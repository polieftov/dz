...
<table>
	...
	foreach($tasks as $task){
		echo "<form action='/', method='POST'> <input type='hidden' name='taskId' value=$task[id]> <input type='hidden' name='status' value=$task[status]<tr><td> $task[task] </td><td> $task[status] </td><td> <input type='submit' value = 'изменить статус'></td></form></tr>";
	}
	?>
</table>
